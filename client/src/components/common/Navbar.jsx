    ...
    <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        ...
        <Link to="/" className="flex items-center gap-2 font-bold text-lg shrink-0">
          ...
          <span className="text-gray-900">Skill<span className="text-indigo-600">Swap</span></span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          {user ? (
            <>
              <span className="hidden sm:flex items-center gap-1.5 bg-indigo-50 text-indigo-700 text-xs font-bold px-3 py-2 rounded-xl">
      ...
      {menuOpen && user && (
        <div className="md:hidden border-t border-gray-100 bg-white px-4 py-3 flex flex-col gap-1 shadow-lg">
          ...
          <Link to="/skills/create" onClick={() => setMenuOpen(false)}
