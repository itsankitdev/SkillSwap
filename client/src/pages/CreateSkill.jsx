...
import {
  GraduationCap, BookOpen, Zap, Tag,
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">
            {isTeach ? 'Share your expertise' : 'Find your next skill'}
          </h1>
          <p className="text-gray-500 mt-2">
            {isTeach
              ? 'List something you can teach and earn credits'
              : 'Tell the community what you want to learn'}
          </p>
        </div>

        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">

          {/* Type Toggle — top banner */}
          ...
          <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-5">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={isTeach
                  ? 'Describe what you will teach, your experience, and what learners will gain...'
                  : 'Describe your current level and what you hope to learn...'}
                ...
                <div className="flex items-center justify-between mb-3">
                  <div>
                    ...
                    <p className="text-xs text-indigo-500 mt-0.5">
                      How many credits learners pay per session
                    </p>
                  </div>
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 font-semibold py-3.5 rounded-2xl transition-all duration-200 text-white shadow-lg disabled:opacity-60 disabled:cursor-not-allowed ${
                isTeach
            ...
            >
              {loading ? (
                ...
                <>
                  {isTeach ? <GraduationCap size={18} /> : <BookOpen size={18} />}
                  Publish {isTeach ? 'Teaching' : 'Learning'} Skill
                </>
              )}
            </button>
        ...
        <p className="text-center text-xs text-gray-400 mt-4">
          You can edit or remove this skill anytime from your dashboard
        </p>
      </div>
    </div>
  );
